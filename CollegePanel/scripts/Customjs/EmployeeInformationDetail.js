...
var app1 = angular.module('informationApp', ['chieffancypants.loadingBar', /*'ngAnimate',*/ 'ui.bootstrap']);
app1.config(function (cfpLoadingBarProvider) {
    cfpLoadingBarProvider.includeSpinner = true;
    cfpLoadingBarProvider.latencyThreshold = 500;
});
app1.controller('informationCtrl', function ($scope, $http, cfpLoadingBar) {
   ...
   // $scope.Name = {};
    $scope.EmployeedetailList = function () {
       ...
       // var Name = $scope.Name.search === undefined ? '' : $scope.Name.search;
        $http.get(Url + "api/empInformationList", {
