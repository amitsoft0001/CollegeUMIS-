   ...
   //debugger;
    ...
    if ($('#Qualification').val() != 1)
    {
        ...
        if ($('#SubjectLLID').val() != "")
        {
            ...
            alert('Please select  LL Subject !!');
            return;
        }
        if ($('#SubjectNRBID').val() != "") {
        ...
        {
            alert('Please select  MB Subject !!');
            return;
        }
        if ($('#SubjectExtraID').val() != undefined)
        {
    ...
    //                debugger;
    //                $.ajax({
    //                    url: "/College/Home/SubjectDetails",
    ...
    //                        }
    //                        else {
    //                            alert("Could not added Subject Details ");
    //                        }
    //                    },
    //                    error: function (errormessage) {
    //                        hideloader();
