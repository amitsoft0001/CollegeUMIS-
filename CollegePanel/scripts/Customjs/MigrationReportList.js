...
app1.controller('enrollmentlistCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.EnrollmentDetailList = function () {
        ...
        $http.get(Url + "api/MigrationReportList", {
            params: { pageIndex: $scope.pageIndex, pageSize: $scope.pageSizeSelected, EducationTypeID: EducationTypeID, CourseCategoryID: CourseCategoryID, Name: Name, RegistrationNo: RegistrationNo, session: session },
