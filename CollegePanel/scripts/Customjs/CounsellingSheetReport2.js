...
$(document).ready(function () {
    ...
    $("[id*=submit]").bind("click", function () {
        ...
        var Education = $("#CollegeName :selected").text();
        var id = $(this).data("id");
        ...
        // debugger;
        $.ajax({
            url: "/College/Home/CounsellingSheetReporCollegeWiset2",
            data: {
            ...
            success: function (data) {
                ...
                result = result + ' <h1>After 2 Scrutiny Remaining College Seat Report</h1>';
                result = result + ' <p> (' + Education + '),Course - ' + semester + ', Academic Session - ' + currentsession + '</p>';
                result = result + '</div>';
                result = result + ' <div class="table-responsive">';
                result = result + '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">';
                result = result + '<tr>';
                result = result + ' <td rowspan="3" align="center" valign="middle" bgcolor="#F9F9F9">Subject</td>';
                ...
                result = result + '<td colspan="5" align="center" valign="middle" bgcolor="#FCF2BE">EBC</td>';
                result = result + '<td colspan="5" align="center" valign="middle" bgcolor="#F0E1FF">BC</td>';
                ...
                $.each(data, function (index, value) {
                    ...
                    console.log(value);
                    result = result + '<tr>';
                    result = result + '<td align="center" valign="middle" bgcolor="#F9F9F9">' + value.streamCategory + '</td>';
