...
app1.controller('examfeelistCtrl', function ($scope, $http, cfpLoadingBar) {
    ...
    $scope.studentListafterfeeSubmit = function () {
        ...
        showloader();
        $http.get(Url + "api/Collegewise_CenterList", {
            params: {
                pageIndex: $scope.pageIndex, pageSize: $scope.pageSizeSelected, CollegeID: CollegeID, session: session, EducationType: EducationType, CourseCategoryID: CourseCategoryID, Subject: Subject, CourseYearID: CourseYearID, Application: Application, ApplicationStatus: ApplicationStatus, paymentStatus: paymentStatus, BackStatus: BackStatus
            },
